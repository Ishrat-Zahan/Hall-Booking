...
<style>
    ...
    .bgc-h-default-l4:hover {
        background-color: #6d48a1 !important;
    }
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div>
                            ...
                            <span style="color: #6d48a1" class="text-600 text-110  align-middle">IZ Hall</span>
                        </div>
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">ID:</span> {{$booking->id}}</div>

                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Customer:</span> {{$booking->user->name}}</div>

                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Customer:</span> {{$booking->user->email}}</div>

                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Issue Date:</span> {{$booking->created_at}}</div>
                ...
                <div class="mt-4">
                    ...
                    <div class="table-responsive">
                        <table class="table  table-striped table-borderless border-0 border-b-2 brc-default-l1">
                            <thead style="background-color: #6d48a1;" class="">
                                <tr class="text-white">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            ...
                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                ...
                                <div class="my-1"> <b class="text-600">Total Amount:{{$booking->total}}</b></div>
