        ...
        <div class="col-lg-5 col-sm-12">
          <div class="contact-infor">
            ...
            <div class="contact-address">
              <ul>
                <li>
                  <i class="zmdi zmdi-home"></i> Address : House 10 , Road 05
                 Mirpur , Dhaka
                </li>
                <li><i class="zmdi zmdi-email"></i> ishratjahan260@gmail.com.com</li>
                <li><i class="zmdi zmdi-phone"></i>01799217813</li>
              </ul>
            </div>
            <div class="work-hours">
              <h5>Working hours</h5>
              <p>
                <strong>Monday &ndash; Saturday</strong>: &nbsp;08AM &ndash;
                22PM
              </p>
            </div>
          </div>
